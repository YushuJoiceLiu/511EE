 ...
 M = 10;
 P = 0.5;
 k_buffer = zeros(1,20); % here is to set up the K=20 value for the buffer
 ...
 title('the average buffer occupancy for k=20')
 figure(2)
 plot(fraction_discard)
 title('the fraction of samples discarded for k=20');